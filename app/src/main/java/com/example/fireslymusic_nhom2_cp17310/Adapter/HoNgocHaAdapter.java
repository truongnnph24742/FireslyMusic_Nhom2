...
public class HoNgocHaAdapter extends RecyclerView.Adapter<HoNgocHaAdapter.HoNgocHaViewHolder>{
    List<Casi> listSong;
    Context context;
    List<Casi> listv1 = new ArrayList<>();
    public HoNgocHaAdapter(Context context) {
    ...
    @NonNull
    @Override
    public HoNgocHaAdapter.HoNgocHaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_chitietcasi,parent,false);
        return new HoNgocHaViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HoNgocHaAdapter.HoNgocHaViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class HoNgocHaViewHolder extends RecyclerView.ViewHolder {
        ImageView img_song;
        TextView tv_namesong,tv_casi;
        LinearLayout layout_bhtd;


        public HoNgocHaViewHolder(@NonNull View itemView) {
            super(itemView);
