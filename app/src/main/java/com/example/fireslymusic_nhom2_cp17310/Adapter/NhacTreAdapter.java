...
public class NhacTreAdapter extends RecyclerView.Adapter<NhacTreAdapter.NhacTreViewHolder>{
    List<Category> listSong;
    Context context;
    List<Category> listv1 = new ArrayList<>();
    public NhacTreAdapter(Context context) {
    ...
    @NonNull
    @Override
    public NhacTreAdapter.NhacTreViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_baoanh,parent,false);
        return new NhacTreViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NhacTreAdapter.NhacTreViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class NhacTreViewHolder extends RecyclerView.ViewHolder {
        ImageView img_song;
        TextView tv_namesong,tv_casi;
        LinearLayout layout_casi;


        public NhacTreViewHolder(@NonNull View itemView) {
            super(itemView);
