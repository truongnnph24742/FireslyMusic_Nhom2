...
public class KarikAdapter extends RecyclerView.Adapter<KarikAdapter.KarikViewHolder>{
    List<Casi> listSong;
    Context context;
    List<Casi> listv1 = new ArrayList<>();
    public KarikAdapter(Context context) {
    ...
    @NonNull
    @Override
    public KarikAdapter.KarikViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_chitietcasi,parent,false);
        return new KarikViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KarikAdapter.KarikViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class KarikViewHolder extends RecyclerView.ViewHolder {
        ImageView img_song;
        TextView tv_namesong,tv_casi;
        LinearLayout layout_bhtd;


        public KarikViewHolder(@NonNull View itemView) {
            super(itemView);
