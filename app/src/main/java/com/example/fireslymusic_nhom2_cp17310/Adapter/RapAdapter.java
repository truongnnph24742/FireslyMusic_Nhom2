...
public class RapAdapter extends RecyclerView.Adapter<RapAdapter.RapViewHolder> {
    ...
    @NonNull
    @Override
    public RapAdapter.RapViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_baoanh,parent,false);
        return new RapViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RapAdapter.RapViewHolder holder, @SuppressLint("RecyclerView") int position) {
