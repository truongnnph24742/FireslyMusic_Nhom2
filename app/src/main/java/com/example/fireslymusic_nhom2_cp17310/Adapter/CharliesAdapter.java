...
public class CharliesAdapter extends RecyclerView.Adapter<CharliesAdapter.CharliesViewHolder> {
    List<Casi> listSong;
    Context context;
    List<Casi> listv1 = new ArrayList<>();

    public CharliesAdapter(Context context) {
    ...
    @NonNull
    @Override
    public CharliesAdapter.CharliesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_chitietcasi,parent,false);
        return new CharliesViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CharliesAdapter.CharliesViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class CharliesViewHolder extends RecyclerView.ViewHolder {
        ImageView img_song;
        TextView tv_namesong,tv_casi;
        LinearLayout layout_bhtd;


        public CharliesViewHolder(@NonNull View itemView) {
            super(itemView);
