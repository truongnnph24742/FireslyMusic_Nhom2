...
public class HoangYenAdapter extends RecyclerView.Adapter<HoangYenAdapter.HoangYenViewHolder> {
    List<Casi> listSong;
    Context context;
    List<Casi> listv1 = new ArrayList<>();
    public HoangYenAdapter(Context context) {
    ...
    @NonNull
    @Override
    public HoangYenAdapter.HoangYenViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_chitietcasi,parent,false);
        return new HoangYenViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HoangYenAdapter.HoangYenViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class HoangYenViewHolder extends RecyclerView.ViewHolder {
        ImageView img_song;
        TextView tv_namesong,tv_casi;
        LinearLayout layout_bhtd;


        public HoangYenViewHolder(@NonNull View itemView) {
            super(itemView);
