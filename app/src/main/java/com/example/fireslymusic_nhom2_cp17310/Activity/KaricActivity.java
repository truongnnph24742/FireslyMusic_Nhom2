...
import com.example.fireslymusic_nhom2_cp17310.Adapter.JackAdapter;
import com.example.fireslymusic_nhom2_cp17310.Adapter.KarikAdapter;
...
public class KaricActivity extends AppCompatActivity {
    ImageView img_anh;
    ...
    RecyclerView rcv_Karik;
    ArrayList<Casi> songlist;
    KarikAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_karic);
        rcv_Karik = findViewById(R.id.rcv_karic);
        ...
        list = new ArrayList<>();
        list.addAll(listv1);
        img_anh = findViewById(R.id.img_karic);
        tv_charlies = findViewById(R.id.tv_karic);
    ...
    private void initializeSongList(){
        ...
        adapter = new KarikAdapter(this);
        LinearLayoutManager manager = new LinearLayoutManager(this, RecyclerView.VERTICAL,false);
        rcv_Karik.setLayoutManager(manager);
        adapter.setData(songlist);
        rcv_Karik.setAdapter(adapter);
    }
    class fetchData extends Thread{
        ...
        public void run() {
            ...
            mainHandel.post(new Runnable() {
                @Override
                public void run() {
                    progressDialog = new ProgressDialog(KaricActivity.this);
