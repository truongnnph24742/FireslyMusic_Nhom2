...
import com.example.fireslymusic_nhom2_cp17310.Adapter.RapAdapter;
import com.example.fireslymusic_nhom2_cp17310.Adapter.USUKAdapter;
...
public class USUKActivity extends AppCompatActivity {
    ImageView img_anh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usukactivity);
        rcv_rap = findViewById(R.id.rcv_usuk);
        ...
        list = new ArrayList<>();
        list.addAll(listv1);
        img_anh = findViewById(R.id.img_usuk);
        tv_listbaoanh = findViewById(R.id.tv_usuk);
    ...
    private void initializeSongList(){
        ...
        adapter = new USUKAdapter(this);
        LinearLayoutManager manager = new LinearLayoutManager(this, RecyclerView.VERTICAL,false);
        rcv_rap.setLayoutManager(manager);
        adapter.setData(songlist);
        rcv_rap.setAdapter(adapter);
    }
    class fetchData extends Thread{
        ...
        public void run() {
            ...
            mainHandel.post(new Runnable() {
                @Override
                public void run() {
                    progressDialog = new ProgressDialog(USUKActivity.this);
