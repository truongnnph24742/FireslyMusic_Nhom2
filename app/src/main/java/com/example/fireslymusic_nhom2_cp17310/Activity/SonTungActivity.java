...
public class SonTungActivity extends AppCompatActivity {
    ImageView img_anh;
    ...
    RecyclerView rcv_sontung;
    ArrayList<Casi> songlist;
    ChiTietCaSiAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_son_tung);
        rcv_sontung = findViewById(R.id.rcv_sontung);
        ...
        list = new ArrayList<>();
        list.addAll(listv1);
        img_anh = findViewById(R.id.img_sontung);
        tv_charlies = findViewById(R.id.tv_sontung);
    ...
    private void initializeSongList(){
        ...
        adapter = new ChiTietCaSiAdapter(SonTungActivity.this);
        LinearLayoutManager manager = new LinearLayoutManager(this, RecyclerView.VERTICAL,false);
        rcv_sontung.setLayoutManager(manager);
        adapter.setData(songlist);
        rcv_sontung.setAdapter(adapter);
    }
    class fetchData extends Thread{
        ...
        public void run() {
            ...
            mainHandel.post(new Runnable() {
                @Override
                public void run() {
                    progressDialog = new ProgressDialog(SonTungActivity.this);
