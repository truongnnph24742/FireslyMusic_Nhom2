...
import com.example.fireslymusic_nhom2_cp17310.Adapter.HoNgocHaAdapter;
...
public class HoNgocHaActivity extends AppCompatActivity {
    ImageView img_anh;
    ...
    RecyclerView rcv_tangphuc;
    ArrayList<Casi> songlist;
    HoNgocHaAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ho_ngoc_ha);
        rcv_tangphuc = findViewById(R.id.rcv_hoha);
        ...
        list = new ArrayList<>();
        list.addAll(listv1);
        img_anh = findViewById(R.id.img_hoha);
        tv_charlies = findViewById(R.id.tv_hoha);
    ...
    private void initializeSongList(){
        ...
        adapter = new HoNgocHaAdapter(this);
        LinearLayoutManager manager = new LinearLayoutManager(this, RecyclerView.VERTICAL,false);
        rcv_tangphuc.setLayoutManager(manager);
        adapter.setData(songlist);
        rcv_tangphuc.setAdapter(adapter);
    }
    class fetchData extends Thread{
        ...
        public void run() {
            ...
            mainHandel.post(new Runnable() {
                @Override
                public void run() {
                    progressDialog = new ProgressDialog(HoNgocHaActivity.this);
