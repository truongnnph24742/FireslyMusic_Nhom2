...
public class BinzActivity extends AppCompatActivity {
    ImageView img_anh;
    TextView tv_binz;
    int position ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_binz);
        rcv_binz = findViewById(R.id.rcv_binz);
        ...
        list = new ArrayList<>();
        list.addAll(listv1);
        img_anh = findViewById(R.id.img_binz);
        tv_binz = findViewById(R.id.tv_binz);
        Glide.with(this).load(list.get(position).getImg_singer()).into(img_anh);
        tv_binz.setText(list.get(position).getSinger_name());
        initializeSongList();
        new fetchData().start();
    }
    ...
    private void initializeSongList(){
        ...
        adapter = new BinzAdapter(BinzActivity.this);
        LinearLayoutManager manager = new LinearLayoutManager(this, RecyclerView.VERTICAL,false);
        rcv_binz.setLayoutManager(manager);
        adapter.setData(songlist);
        rcv_binz.setAdapter(adapter);
    }
    class fetchData extends Thread{
        ...
        public void run() {
            ...
            mainHandel.post(new Runnable() {
                @Override
                public void run() {
                    progressDialog = new ProgressDialog(BinzActivity.this);
