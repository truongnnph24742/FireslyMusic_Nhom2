...
public class JackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcv_jack = findViewById(R.id.rcv_jack);
        ...
        list = new ArrayList<>();
        list.addAll(listv1);
        img_anh = findViewById(R.id.img_jack);
        tv_charlies = findViewById(R.id.tv_jack);
    ...
    private void initializeSongList(){
        ...
        adapter = new JackAdapter(this);
        LinearLayoutManager manager = new LinearLayoutManager(this, RecyclerView.VERTICAL,false);
        rcv_jack.setLayoutManager(manager);
        adapter.setData(songlist);
        rcv_jack.setAdapter(adapter);
    }
    class fetchData extends Thread{
        ...
        public void run() {
            ...
            mainHandel.post(new Runnable() {
                @Override
                public void run() {
                    progressDialog = new ProgressDialog(JackActivity.this);
