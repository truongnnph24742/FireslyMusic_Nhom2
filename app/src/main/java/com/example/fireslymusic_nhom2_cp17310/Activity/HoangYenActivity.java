...
import com.example.fireslymusic_nhom2_cp17310.Adapter.CharliesAdapter;
import com.example.fireslymusic_nhom2_cp17310.Adapter.HoangYenAdapter;
...
public class HoangYenActivity extends AppCompatActivity {
    ImageView img_anh;
    ...
    RecyclerView rcv_thuylinh;
    ArrayList<Casi> songlist;
    HoangYenAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hoang_yen);
        rcv_thuylinh = findViewById(R.id.rcv_hoangyen);
        ...
        list = new ArrayList<>();
        list.addAll(listv1);
        img_anh = findViewById(R.id.img_hoangyen);
        tv_charlies = findViewById(R.id.tv_hoangyen);
    ...
    private void initializeSongList(){
        ...
        adapter = new HoangYenAdapter(this);
        LinearLayoutManager manager = new LinearLayoutManager(this, RecyclerView.VERTICAL,false);
        rcv_thuylinh.setLayoutManager(manager);
        adapter.setData(songlist);
        rcv_thuylinh.setAdapter(adapter);
    }
    class fetchData extends Thread{
        ...
        public void run() {
            ...
            mainHandel.post(new Runnable() {
                @Override
                public void run() {
                    progressDialog = new ProgressDialog(HoangYenActivity.this);
