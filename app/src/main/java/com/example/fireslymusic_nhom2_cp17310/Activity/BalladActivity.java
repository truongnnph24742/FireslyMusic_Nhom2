...
public class BalladActivity extends AppCompatActivity {
    ...
    RecyclerView rcv_ballad;
    ArrayList<Category> songlist;
    BalladAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ballad);
        rcv_ballad = findViewById(R.id.rcv_ballad);
        ...
        list = new ArrayList<>();
        list.addAll(listv1);
        img_anh = findViewById(R.id.img_ballad);
        tv_listbaoanh = findViewById(R.id.tv_ballad);
    ...
    private void initializeSongList(){
        ...
        adapter = new BalladAdapter(this);
        LinearLayoutManager manager = new LinearLayoutManager(this, RecyclerView.VERTICAL,false);
        rcv_ballad.setLayoutManager(manager);
        adapter.setData(songlist);
        rcv_ballad.setAdapter(adapter);
    }
    class fetchData extends Thread{
        ...
        public void run() {
            ...
            mainHandel.post(new Runnable() {
                @Override
                public void run() {
                    progressDialog = new ProgressDialog(BalladActivity.this);
