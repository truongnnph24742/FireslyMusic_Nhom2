...
import com.example.fireslymusic_nhom2_cp17310.Adapter.BinzAdapter;
...
public class CharliesActivity extends AppCompatActivity {
    ImageView img_anh;
    ...
    RecyclerView rcv_charlies;
    ArrayList<Casi> songlist;
    CharliesAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_charlies);
        rcv_charlies = findViewById(R.id.rcv_charlies);
        ...
        list = new ArrayList<>();
        list.addAll(listv1);
        img_anh = findViewById(R.id.img_charlies);
        tv_charlies = findViewById(R.id.tv_charlies);
    ...
    private void initializeSongList(){
        ...
        adapter = new CharliesAdapter(this);
        LinearLayoutManager manager = new LinearLayoutManager(this, RecyclerView.VERTICAL,false);
        rcv_charlies.setLayoutManager(manager);
        adapter.setData(songlist);
        rcv_charlies.setAdapter(adapter);
    }
    class fetchData extends Thread{
        ...
        public void run() {
            ...
            mainHandel.post(new Runnable() {
                @Override
                public void run() {
                    progressDialog = new ProgressDialog(CharliesActivity.this);
